...
![](/archives/nodejs-nvm/a3qqdq.png)

## NVM 的主要原理

1、NVM 将不同版本的 node 安装到 nvm 自身的路径下

![](/archives/nodejs-nvm/2pdxao.png)
...
![](/archives/nodejs-nvm/e5oisn.png)
...
![](/archives/nodejs-nvm/m741b9.png)
